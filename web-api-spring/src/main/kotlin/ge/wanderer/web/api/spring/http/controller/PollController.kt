...
class PollController(
    ...
    @GetMapping("/{id}")
    fun getPoll(@PathVariable id: Long, @RequestHeader(name = "user-token", required = false) loggedInUserId: String?): ResponseEntity<ServiceResponse<DiscussionElementData>> =
